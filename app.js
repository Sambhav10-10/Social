  ...
  db.connect((err) => {
    ...
    db.query(`CREATE TABLE IF NOT EXISTS users (
      ...
      db.query(`CREATE TABLE IF NOT EXISTS themes (
        ...
        if (err) return console.error('Error creating themes table:', err);
        ...
        db.query(`CREATE TABLE IF NOT EXISTS posts (
          ...
          if (err) return console.error('Error creating posts table:', err);
          ...
          db.query(`CREATE TABLE IF NOT EXISTS media (
            ...
            if (err) return console.error('Error creating media table:', err);
            ...
            db.query(`CREATE TABLE IF NOT EXISTS notifications (
              ...
              db.query(`CREATE TABLE IF NOT EXISTS likes (
                ...
                if (err) return console.error('Error creating likes table:', err);
                ...
                db.query(`CREATE TABLE IF NOT EXISTS comments (
                  ...
                  if (err) return console.error('Error creating comments table:', err);
                  ...
                  db.query(`CREATE TABLE IF NOT EXISTS saved_posts (
                    ...
                    if (err) return console.error('Error creating saved_posts table:', err);
                    ...
                    db.query(`CREATE TABLE IF NOT EXISTS followers (
                      ...
                      if (err) return console.error('Error creating followers table:', err);
                      console.log('Followers table created or already exists');

                      db.query(`INSERT IGNORE INTO themes (name, primary_color, secondary_color, text_color, accent_color, border_color, background_color)
                        VALUES 
                        ('light', '#007bff', '#6c757d', '#333', '#28a745', '#dee2e6', '#fff'),
                        ('dark', '#0d6efd', '#adb5bd', '#f8f9fa', '#198754', '#495057', '#212529')`, (err) => {
                        if (err) return console.error('Error inserting default themes:', err);
